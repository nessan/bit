...
::: {.callout-caution}
# Empty bit-vectors
Calling these methods for an empty bit-vector is likely an error --- if you set the `BIT_VERIFY` flag at compile time, we throw an exception with a helpful message.
