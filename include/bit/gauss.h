...
public:
    ...
    gauss(const matrix_type& A, const vector_type& b)
    {
        ...
        bit_verify(A.rows() == b.size(), "A.rows() = {} but b.size() = {}.", A.rows(), b.size());
    ...
    vector_type operator()() const
    {
        ...
        bit_verify(is_consistent(), "System is inconsistent so has NO solutions");
    ...
    vector_type operator()(std::size_t ns) const
    {
        ...
        bit_verify(ns < m_count, "Argument ns = {} is not less than solution count = {}!", ns, m_count);
